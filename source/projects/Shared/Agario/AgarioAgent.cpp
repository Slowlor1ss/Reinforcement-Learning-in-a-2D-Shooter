...
//void AgarioAgent::SetToWanderWhileAvoidingEdge()
//{
//	m_pFlee->SetTarget(Elite::Vector2{0,0});
//	m_pBlendedSteering->ClearBehaviour();
//	m_pBlendedSteering->AddBehaviour({ m_pFlee, 0.3f });
//	m_pBlendedSteering->AddBehaviour({ m_pWander, 0.7f });
...
void AgarioAgent::SetToEvade(Elite::Vector2 fleePos)
{
	m_pEvade->SetTarget(fleePos);
	SetSteeringBehavior(m_pEvade);
}

//void AgarioAgent::SetToEvadeWhileAvoidingEdge(Elite::Vector2 fleePos, Elite::Vector2 CenterPos)
//{
//	m_pFlee->SetTarget(Elite::Vector2{ 0,0 });
//	m_pEvade->SetTarget(fleePos);
//	m_pBlendedSteering->ClearBehaviour();
//	m_pBlendedSteering->AddBehaviour({ m_pFlee, 0.3f });
//	m_pBlendedSteering->AddBehaviour({ m_pEvade, 0.7f });
//	SetSteeringBehavior(m_pBlendedSteering);
//}
