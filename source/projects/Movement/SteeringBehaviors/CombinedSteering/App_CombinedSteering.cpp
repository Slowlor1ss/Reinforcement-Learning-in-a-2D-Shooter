...
// 	m_pWander->SetMaxAngleChange(ToRadians(25));
// 	m_pWander->SetWanderOffset(0.f);
// 
// 	m_pWanderAgent = new SteeringAgent();
// 	m_pWanderAgent->SetSteeringBehavior(m_pWander);
// 	m_pWanderAgent->SetBodyColor(Color(1, 0, 0));
// 	m_pWanderAgent->SetAutoOrient(true);
}
...
// 	m_pWanderAgent->Render(deltaTime);
// 	m_pWanderAgent->SetRenderBehavior(m_CanDebugRender);
